        ...
        children: [
          AlertDialog(
            ...
            actions: [
              AppButton(
                title: 'Remove',
                backgroundColor: fromRenewScreen
                    ? Colors.red.shade50
                    : Colors.blue.shade50,
                style: Theme.of(context).textTheme.labelLarge!.copyWith(
                  color: fromRenewScreen
                      ? Colors.red.shade600
                ...
                onPressed: () {
                  if (fromHome != null && fromHome) {
                    ...
                    context.read<DetailBloc>().add(
                      DeleteHabitDetailEvent(habit.id),
                    );
                  }
                  if (fromRenewScreen) {
                ...
                onPressed: () {
                  if (fromRenewScreen) {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => GoalRenewalScreen(habit: habit),
                      ),
                    );
                  }
                },
