...
class AppColors {
  ...
  static final List<Map<String, dynamic>> extraDarkColors = [
    {"id": 0, "color": Colors.red[900]!},
    {"id": 1, "color": Colors.pink[900]!},
    {"id": 2, "color": Colors.purple[900]!},
    {"id": 3, "color": Colors.deepPurple[900]!},
    {"id": 4, "color": Colors.indigo[900]!},
    {"id": 5, "color": Colors.blue[900]!},
    {"id": 6, "color": Colors.lightBlue[900]!},
    {"id": 7, "color": Colors.cyan[900]!},
    {"id": 8, "color": Colors.teal[900]!},
    {"id": 9, "color": Colors.green[900]!},
    {"id": 10, "color": Colors.lightGreen[900]!},
    {"id": 11, "color": Colors.lime[900]!},
    {"id": 12, "color": Colors.yellow[900]!},
    {"id": 13, "color": Colors.amber[900]!},
    {"id": 14, "color": Colors.orange[900]!},
    {"id": 15, "color": Colors.deepOrange[900]!},
    {"id": 16, "color": Colors.brown[900]!},
  ];
}
